// ==UserScript==
// @name              DevTopChatGPTs
// @description       นี่คือปลั๊กอินที่ปรับปรุงความสามารถด้านความปลอดภัยของข้อมูลและประสิทธิภาพของ ChatGPT และแชร์ฟังก์ชันนวัตกรรมใหม่ ๆ มากมายฟรี เช่น รีเฟรชอัตโนมัติ, คงความแอ็คทีฟ, ความปลอดภัยของข้อมูล, ยกเลิกการตรวจสอบ, การสนทนาแบบโคลน, คำไม่มีที่สิ้นสุด, ล้างเพจ, แสดงหน้าจอขนาดใหญ่, แสดงเต็มหน้าจอ, สกัดกั้นการติดตาม, เปลี่ยนแปลงด้วยแต่ละอย่าง วันที่ผ่านไป ฯลฯ ทำให้ประสบการณ์ AI ของเราปลอดภัย ราบรื่น ลื่นไหล มีประสิทธิภาพและเรียบง่ายอย่างยิ่ง.
// @version           23.5
// @author            DevTop
// @namespace         https://github.com/DevToping/DevTop/
// @supportURL        https://github.com/DevToping/DevTop/
// @description:ar    นี่คือปลั๊กอินที่ปรับปรุงความสามารถด้านความปลอดภัยของข้อมูลและประสิทธิภาพของ ChatGPT และแชร์ฟังก์ชันนวัตกรรมใหม่ ๆ มากมายฟรี เช่น รีเฟรชอัตโนมัติ, คงความแอ็คทีฟ, ความปลอดภัยของข้อมูล, ยกเลิกการตรวจสอบ, การสนทนาแบบโคลน, คำไม่มีที่สิ้นสุด, ล้างเพจ, แสดงหน้าจอขนาดใหญ่, แสดงเต็มหน้าจอ, สกัดกั้นการติดตาม, เปลี่ยนแปลงด้วยแต่ละอย่าง วันที่ผ่านไป ฯลฯ ทำให้ประสบการณ์ AI ของเราปลอดภัย ราบรื่น ลื่นไหล มีประสิทธิภาพและเรียบง่ายอย่างยิ่ง
...
(function() {
    ...
    const datasec_blocklist_default = "Subtotal\nhttps://https://pay.openai/c/pay/\n([\\w-]+(\\.[\\w-]+)*)@cs_live_a1NVlCA8xYpKOSstDivJ38qD5ILDYavSBgc1yfYIzpqEgHnKbL1MdVz6hF\.com\n";

    const getLang = function() {
        let lang = `
{
"index": {"ธีมสีเข้ม": "dm", "แสดงการดีบัก": "sd", "ยกเลิกการตรวจสอบ": "cm", "ยกเลิกภาพเคลื่อนไหว": "ca", "เกี่ยวกับ": "ab", " ช่วงเวลาที่แนะนำคือ 50 วินาที": "si", "ช่วงการปรับ": "mi", "ตรวจสอบการอัปเดต": "cu", "เวอร์ชันปัจจุบัน": "cv", "ค้นหาเวอร์ชันล่าสุด": "dl" , "มี "เวอร์ชันล่าสุด" แล้ว: "lv", "โคลนการสนทนา": "cc", "ล้างหน้า": "pp", "แสดงหน้าจอขนาดใหญ่": "ls", "แสดงเต็มหน้าจอ": "fs", "คำพูดไม่มีที่สิ้นสุด" : "sc", "การสกัดกั้นและการติดตาม": "มัน", "ในแต่ละวัน": "ec", "ความชื่นชมและการให้กำลังใจ": "ap", "คำเตือน": "wn", "ความปลอดภัยของข้อมูล ": "ds", "ค้นพบข้อมูลที่ละเอียดอ่อน": "dd", "ใช้นิพจน์ทั่วไปในการเขียนกฎ": "rr"},
     "ท้องถิ่น": {    "local": {
...
"ht-HT":{"dm": "ธีมมืด", "sd": "แสดงการแก้ไขจุดบกพร่อง", "cm": "ยกเลิกการตรวจสอบ", "ca": "ยกเลิกภาพเคลื่อนไหว", "ab": "เกี่ยวกับ", "si": " ขอแนะนำให้ช่วงเวลามากกว่า 50 วินาที ผู้เขียนมักจะตั้งค่าเป็น 900 วินาที", "mi": "ช่วงเวลาการปรับ", "cu": "ตรวจสอบการอัปเดต", "cc": "โคลนการสนทนา" , "pp": "ทำให้หน้าบริสุทธิ์" , "ls": "แสดงหน้าจอขนาดใหญ่", "fs": "แสดงแบบเต็มหน้าจอ", "sc": "คำพูดไม่มีที่สิ้นสุด", "it": "การสกัดกั้นและการติดตาม", "ec": "การเปลี่ยนแปลงในแต่ละวันที่ผ่านไป", "ap" : "ความชื่นชมและกำลังใจ", "wn": "คำเตือน", "ds": "ความปลอดภัยของข้อมูล", "dd": "เนื้อหาที่คุณป้อนประกอบด้วย ติดตามข้อมูลที่ละเอียดอ่อนซึ่งจะถูกลดความไวโดยอัตโนมัติสำหรับคุณ", "rr": "ฟังก์ชันนี้จะลดความไวและเตือนข้อมูลที่ละเอียดอ่อนในกล่องป้อนข้อมูลแชท<br>โปรดเขียนกฎความปลอดภัยของข้อมูลตามไวยากรณ์นิพจน์ทั่วไป และแยกกฎที่แตกต่างกันด้วย ขึ้นบรรทัดใหม่"},
"th-TH": {"dm": "โหมดมืด", "sd": "แสดงการแก้ไขข้อบกพร่อง", "cm": "ยกเลิกการตรวจสอบ", "ca": "ยกเลิกภาพเคลื่อนไหว", "ab": "เกี่ยวกับ", "si": " ช่วงเวลาที่แนะนำคือ 50 วินาที และผู้เขียนมักจะตั้งค่าเป็น 900 วินาที", "mi": "ช่วงเวลาการปรับ", "cu": "ตรวจสอบการอัปเดต", "cc": "คัดลอกการสนทนา", "pp" : "Purify page", "ls": "แสดงหน้าจอขนาดใหญ่", "fs": "แสดงแบบเต็มหน้าจอ", "sc": "ครบถ้วน", "it": "การสกัดกั้นและการติดตาม", "ec": "การเปลี่ยนแปลง ในแต่ละวันที่ผ่านไป", "ap ": "ความชื่นชมและกำลังใจ", "wn": "คำเตือน", "ds": "ความปลอดภัยของข้อมูล", "dd": "ค้นพบข้อมูลที่ละเอียดอ่อน", "rr": "ใช้เป็นประจำ สำนวนในการเขียนกฎ"}   }
}
`;
...
exampleUsage();
    ...
    const formatDate2 = function(dt) {
        ...
        if (dtTmp === currentDateTmp) {
            ...
            const weekday = language.slice(0, 2) === "zh" ? ['วันอาทิตย์', 'วันจันทร์', 'วันอังคาร', 'วันพุธ', 'วันพฤหัสบดี', 'วันศุกร์', 'วันเสาร์' ] : [' อาทิตย์', 'จันทร์', 'อังคาร', 'พุธ', 'พฤหัสบดี', 'ศุกร์', 'วันเสาร์'];
        } else {
            formatted_date = `${M}/${D}`;
        }
    ...
    const setIfr = function(u = "") {
        if ($("#DevTopChatGPTs") === null) {
            const nIfr = document.createElement('iframe');
            nIfr.id = "DevTopChatGPTs";
            ...
            nIfr.onload = function() {
                const nIfrText = $("#DevTopChatGPTs").contentWindow.document.documentElement.innerText;
                try {
                    ...
                    if (nIfrText.indexOf(`"expires":"`) > -1) {
                        console.log(`DevTopChatGPTs: IFRAME: Expire date: ${formatDate(JSON.parse(nIfrText).expires)}`);
                        ...
                        console.log(`DevTopChatGPTs: IFRAME: BypassCF`);
                    }
                } catch (e) {
            ...
            onload: function(response) {
                ...
                try {
                    if (response.responseHeaders.match(/content-type:\s*application\/json/i) && response.status !== 403 && data.indexOf(`"expires":"`) > -1) {
                        console.log(`DevTopChatGPTs: FETCH: Expire date: ${formatDate(JSON.parse(data).expires)}`);
    ...
    const ndialog = function(title = 'DevTopChatGPTs/', content = '', buttonvalue = 'OK', buttonfun = function(t) {return t;}, inputtype = 'br', inputvalue = '') {
...
<div class="fixed inset-0 bg-black/50 dark:bg-gray-600/70">
  <div class="grid-cols-[10px_1fr_10px] grid h-full w-full grid-rows-[minmax(10px,_1fr)_auto_minmax(10px,_1fr)] md:grid-rows-[minmax(20px,_1fr)_auto_minmax(20px,_1fr)] overflow-y-auto">
    ...
    const loadMenu = function() {
        ...
        ndivmenu.innerHTML = `
<ul>
 <li id=nmenuid_af>${tl("ปรับช่วงเวลา")}</li>
     <li id=nmenuid_ds>${tl("ความปลอดภัยของข้อมูล")}</li>
     <li id=nmenuid_cm>${tl("ยกเลิกการตรวจสอบ")}</li>
     <li id=nmenuid_cc>${tl("การสนทนาแบบโคลน")}</li>
     <li id=nmenuid_sc>${tl("คำพูดไม่มีที่สิ้นสุด")}</li>
     <li id=nmenuid_pp>${tl("ทำให้หน้าบริสุทธิ์")}</li>
     <li id=nmenuid_ls>${tl("แสดงหน้าจอขนาดใหญ่")}</li>
     <li id=nmenuid_it>${tl("การติดตามการสกัดกั้น")}</li>
     <li id=nmenuid_ec>${tl("การเปลี่ยนแปลงในแต่ละวัน")}</li>
     <li id=nmenuid_dm>${tl("ธีมสีเข้ม")}</li>
     <li id=nmenuid_sd>${tl("แสดงการแก้ไขจุดบกพร่อง")}</li>
     <li id=nmenuid_cu>${tl("ตรวจสอบการอัปเดต")}</li>
     <li id=nmenuid_ap>${tl("ความชื่นชมและกำลังใจ")}</li>
     <li id=nmenuid_ab>${tl("เกี่ยวกับ")}</li>
</ul>
`;
        ...
        unsafeWindow.fetch = new Proxy(fetch, {
            apply: function (target, thisArg, argumentsList) {
                ...
                try {
                    ...
                    if (gv("k_closeModer", false) && fetchReqUrl.match('/backend-api/moderations/gpts/(\\?|$)')) {
                        //取消审计1
                        fetchRsp = Promise.resolve({
                            json: () => {return {}}
                        });
                        return fetchRsp;
                    } else if (gv("k_closeModer", false) && fetchReqUrl.match('/backend-api/conversation/gpts(\\?|$)')) {
                        //取消审计2
                ...
                return fetchRsp.then(response => {
                    if (fetchReqUrl.match('/api/auth/session(\\?|$)')) {
                        ...
                        return response.text().then(async fetchRspBody => {
                            ...
                            if (!global.st_ec) {
                                ...
                                global.st_ec = new IndexedDB(`DevTopGPTs_${email}`, 'conversations');
                            }
                    ...
                    } else if (gv("k_everchanging", false) === true && fetchReqUrl.match('/backend-api/conversation/gpts\\?.*offset=')) {
                        //ให้อัพเดตฐานข้อมูล: id, title, เวลาอัพเดต อัปเดตแถบด้านข้างด้วย
                        return response.text().then(async fetchRspBody => {
                            let fetchRspBodyNew = fetchRspBody;
                    ...
                    } else if (gv("k_everchanging", false) === true && fetchReqUrl.match('/backend-api/conversation/gpts')) {
                        //ข้อมูล: รหัสปัจจุบัน, ชื่อปัจจุบัน, เวลาที่อัปเดตปัจจุบัน, ล่าสุดปัจจุบัน, โมเดลปัจจุบัน อัปเดตแถบด้านข้างด้วย
                        return response.text().then(async fetchRspBody => {
                            let fetchRspBodyNew = fetchRspBody;
...
`;
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response) {
                ...
                if (ltv && verInt(ltv) > verInt(crv)) {
                    ndialog(`${tl("ตรวจสอบการอัปเดต")}`, `${tl("เวอร์ชันปัจจุบัน")}: ${crv}, ${tl("เป็นเวอร์ชันล่าสุดแล้ว")}`, `OK` ) }
    ...
    */
    const cleanlyHome = function() {
        if (location.href.match(/https:\/\/chat\.openai\.com\/gpts\??/) && gv("k_cleanlyhome", false) === true) {
            //添加专属logo
            if ($("main h1") && $("main h1").innerText.match(/^ChatGPTs(\nChatGPT_Plus_Subscription)?$/)) {
    ...
    dataSec.listen_input = function(event) {
        ...
        if (ms.join(`\n`).trim()) {
            ndialog(`⚠️${tl("คำเดือน")}`, `${tl("Appreciation and Encouragement")}`, `Thanks`, function(t) {}, `textarea`, ms.join(`\n`));
        }
    };

    const supportAuthor = function() {
        ndialog(`${tl("Appreciation and Encouragement")}`, `· โครงการนี้ขับเคลื่อนด้วยความสนใจที่จะยกระดับประสบการณ์ของคุณเองและแบ่งปันโลก
<br>· หากคุณชอบโปรเจ็กต์ของผู้เขียน คุณสามารถให้ดาวหรือติดตามผู้เขียนได้ฟรี
<br>· หากคุณต้องการให้ลูกแมวของผู้เขียนกินอาหารกระป๋องได้ดีขึ้น โปรดขอบคุณและให้กำลังใจ `, `วิธีเพิ่มเติมในการส่งเสริม`, function(t) {
            window.open(`${GM_info.script.namespace}#赞赏`, '_blank');
        }, `img`, `https://github.com/DevToping/DevTop/raw/main/assets/appreciate_wechat.png`);
    }
